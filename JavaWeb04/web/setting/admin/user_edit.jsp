...
<form class="layui-form" action="" lay-filter="user_edit" name="user_edit" method="post" enctype="multipart/form-data">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="icon" id="iconName" autocomplete="off" placeholder="" class="layui-input"  disabled="" style="background:#D2D2D2">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <img id="iconShow" style="height: 150px; width: 150px;">
