...
<form name='dataset_edit' class="layui-form" action="" lay-filter="dataset_edit">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="publish_state" value="1" title="已发布">
            <input type="radio" name="publish_state" value="0" title="未发布">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="selected_state" lay-skin="switch" lay-text="ON|OFF">
        </div>
    </div>
